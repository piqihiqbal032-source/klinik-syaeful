...
\restrict nraqGvqYQG5ELqcGeCiD4BmzOOzdnQc8eoKcCv9YabeDk0ik3jWE1SUTiwtDgnG
...
--
-- Name: jadwal_dokter_id_jadwal_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.jadwal_dokter_id_jadwal_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.jadwal_dokter_id_jadwal_seq OWNER TO postgres;

--
-- Name: jadwal_dokter_id_jadwal_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.jadwal_dokter_id_jadwal_seq OWNED BY public.jadwal_dokter.id_jadwal;
...
CREATE TABLE public.kegiatan (
    ...
    updated_at timestamp(0) without time zone,
    category_id bigint,
    CONSTRAINT kegiatan_status_check CHECK (((status)::text = ANY (ARRAY[('aktif'::character varying)::text, ('tidak_aktif'::character varying)::text])))
);
...
--
-- Name: kontak_klinik; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.kontak_klinik (
    id_kontak bigint NOT NULL,
    alamat_lengkap text NOT NULL,
    nomor_telepon character varying(20) NOT NULL,
    email character varying(100) NOT NULL,
    media_sosial character varying(255),
    link_peta text,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
...
ALTER TABLE public.kontak_klinik OWNER TO postgres;

--
-- Name: kontak_klinik_id_kontak_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.kontak_klinik_id_kontak_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.kontak_klinik_id_kontak_seq OWNER TO postgres;

--
-- Name: kontak_klinik_id_kontak_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.kontak_klinik_id_kontak_seq OWNED BY public.kontak_klinik.id_kontak;


--
-- Name: layanan_medis; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.layanan_medis (
    id_layanan bigint NOT NULL,
    nama_layanan character varying(100) NOT NULL,
    deskripsi text NOT NULL,
    gambar character varying(255),
    status_aktif character varying(255) DEFAULT 'aktif'::character varying NOT NULL,
    created_at timestamp(0) without time zone,
    updated_at timestamp(0) without time zone,
    ...
    persyaratan text,
    status_bpjs character varying(255) DEFAULT 'BPJS & Umum'::character varying NOT NULL,
    foto character varying(255),
    CONSTRAINT layanan_medis_status_aktif_check CHECK (((status_aktif)::text = ANY (ARRAY[('aktif'::character varying)::text, ('tidak_aktif'::character varying)::text]))),
    CONSTRAINT layanan_medis_status_bpjs_check CHECK (((status_bpjs)::text = ANY (ARRAY[('BPJS'::character varying)::text, ('Umum'::character varying)::text, ('BPJS & Umum'::character varying)::text])))
);


ALTER TABLE public.layanan_medis OWNER TO postgres;

--
-- Name: layanan_medis_id_layanan_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.layanan_medis_id_layanan_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.layanan_medis_id_layanan_seq OWNER TO postgres;

--
-- Name: layanan_medis_id_layanan_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.layanan_medis_id_layanan_seq OWNED BY public.layanan_medis.id_layanan;
...
--
-- Name: pengumuman_libur; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.pengumuman_libur (
    id bigint NOT NULL,
...
ALTER TABLE public.pengumuman_libur OWNER TO postgres;

--
-- Name: pengumuman_libur_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.pengumuman_libur_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.pengumuman_libur_id_seq OWNER TO postgres;

--
-- Name: pengumuman_libur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.pengumuman_libur_id_seq OWNED BY public.pengumuman_libur.id;


--
-- Name: profil_klinik; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.profil_klinik (
    id_profil bigint NOT NULL,
    sejarah_singkat text NOT NULL,
    visi_misi text NOT NULL,
    struktur_organisasi text,
    nomor_izin character varying(50) NOT NULL,
    updated_at timestamp(0) without time zone,
    visi text,
    misi text,
    moto text,
...
ALTER TABLE public.profil_klinik OWNER TO postgres;

--
-- Name: profil_klinik_id_profil_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.profil_klinik_id_profil_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.profil_klinik_id_profil_seq OWNER TO postgres;

--
-- Name: profil_klinik_id_profil_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.profil_klinik_id_profil_seq OWNED BY public.profil_klinik.id_profil;
...
--
-- Name: jadwal_dokter id_jadwal; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.jadwal_dokter ALTER COLUMN id_jadwal SET DEFAULT nextval('public.jadwal_dokter_id_jadwal_seq'::regclass);
...
--
-- Name: kontak_klinik id_kontak; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kontak_klinik ALTER COLUMN id_kontak SET DEFAULT nextval('public.kontak_klinik_id_kontak_seq'::regclass);


--
-- Name: layanan_medis id_layanan; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.layanan_medis ALTER COLUMN id_layanan SET DEFAULT nextval('public.layanan_medis_id_layanan_seq'::regclass);
...
--
-- Name: pengumuman_libur id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pengumuman_libur ALTER COLUMN id SET DEFAULT nextval('public.pengumuman_libur_id_seq'::regclass);


--
-- Name: profil_klinik id_profil; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.profil_klinik ALTER COLUMN id_profil SET DEFAULT nextval('public.profil_klinik_id_profil_seq'::regclass);
...
ALTER TABLE ONLY public.jadwal_dokter
    ADD CONSTRAINT jadwal_dokter_pkey PRIMARY KEY (id_jadwal);
...
--
-- Name: kontak_klinik kontak_klinik_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kontak_klinik
    ADD CONSTRAINT kontak_klinik_pkey PRIMARY KEY (id_kontak);


--
-- Name: layanan_medis layanan_medis_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.layanan_medis
    ADD CONSTRAINT layanan_medis_pkey PRIMARY KEY (id_layanan);


--
-- Name: layanan_medis layanan_medis_slug_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.layanan_medis
    ADD CONSTRAINT layanan_medis_slug_unique UNIQUE (slug);
...
--
-- Name: pengumuman_libur pengumuman_libur_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pengumuman_libur
    ADD CONSTRAINT pengumuman_libur_pkey PRIMARY KEY (id);


--
-- Name: profil_klinik profil_klinik_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.profil_klinik
    ADD CONSTRAINT profil_klinik_pkey PRIMARY KEY (id_profil);
...
--
-- Name: kegiatan kegiatan_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kegiatan
    ADD CONSTRAINT kegiatan_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id);


--
-- Name: pengumuman_libur pengumuman_libur_dokter_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pengumuman_libur
    ADD CONSTRAINT pengumuman_libur_dokter_id_foreign FOREIGN KEY (dokter_id) REFERENCES public.jadwal_dokter(id_jadwal) ON DELETE CASCADE;
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.cache TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.cache TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.cache TO service_role;
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.cache_locks TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.cache_locks TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.cache_locks TO service_role;
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.failed_jobs TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.failed_jobs TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.failed_jobs TO service_role;


--
-- Name: TABLE jadwal_dokter; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.jadwal_dokter TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.jadwal_dokter TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.jadwal_dokter TO service_role;
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.job_batches TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.job_batches TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.job_batches TO service_role;
...
--
-- Name: TABLE kegiatan; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.kegiatan TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.kegiatan TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.kegiatan TO service_role;


--
-- Name: TABLE kontak_klinik; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.kontak_klinik TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.kontak_klinik TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.kontak_klinik TO service_role;


--
-- Name: TABLE layanan_medis; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.layanan_medis TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.layanan_medis TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.layanan_medis TO service_role;
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.migrations TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.migrations TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.migrations TO service_role;
...
--
-- Name: TABLE pengumuman_libur; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.pengumuman_libur TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.pengumuman_libur TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.pengumuman_libur TO service_role;


--
-- Name: TABLE profil_klinik; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.profil_klinik TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.profil_klinik TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE public.profil_klinik TO service_role;
...
\unrestrict nraqGvqYQG5ELqcGeCiD4BmzOOzdnQc8eoKcCv9YabeDk0ik3jWE1SUTiwtDgnG
